...
urlpatterns = [
    ...
    url(r'^planning/',
        include(('SciLRtool.reviews.planning.urls', 'SciLRtool.reviews.planning'), namespace='planning')),
    url(r'^conducting/',
        include(('SciLRtool.reviews.conducting.urls', 'SciLRtool.reviews.conducting'), namespace='conducting')),
    url(r'^reporting/',
        include(('SciLRtool.reviews.reporting.urls', 'SciLRtool.reviews.reporting'), namespace='reporting')),
